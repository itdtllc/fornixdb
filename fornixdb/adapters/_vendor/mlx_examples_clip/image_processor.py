...
#
# Vendored verbatim from Apple's mlx-examples (MIT), clip/image_processor.py:
#   https://github.com/ml-explore/mlx-examples/blob/main/clip/image_processor.py
# See the LICENSE file in this directory. Runtime deps are mlx + numpy + PIL.
